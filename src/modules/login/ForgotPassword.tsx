...
export default function ForgotPassword() {
  ...
  const onSubmit = (data: any, actions: FormikHelpers<any>) => {
    post(
      ...
      () => {
        Toast.error(
          'Sorry, we encountered an issue while processing your password reset request. Please double-check the email address you provided and try again. If the problem persists, please contact the platform administrator for further assistance.',
        );
